<x-app-layout>
    ...
    <main style="background-color: #fff;">
        ...
        <div class="main-body" style="background-color: #fff; padding: 40px 0;">
            ...
            <div>
                <div class="text-center fs-2 mb-3 fw-bold text-black pb-3"
            ...
            <section class="top-selling-section py-5">
                <div class="container">
                                    ...
                                    <div class="product-info p-3">
                                        ...
                                        <div class="product-meta">
                                            <small class="text-muted">
                                                ...
                                                @if ($product->model)
                                                    <span class="ms-2"><i
                                                            class="fa-solid fa-cube me-1"></i>{{ $product->model }}</span>
                                                @endif
                                            </small>
                                        </div>
                                    </div>
                    ...
                    <div class="text-center">
                        <a href="{{ route('frontend.products.all') }}" class="btn btn-primary btn-lg px-5 py-3">
        ...
        @if ($featuredNews->count() > 0)
            <div class="featured-news-section bg-white py-5">
                <div class="container">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="news-card h-100 position-relative">
                                    ...
                                    <div class="overflow-hidden" style="height: 200px;">
                                        <a
                                            href="{{ route('frontend.news.detail', ['type' => $news->news_type, 'slug' => $news->slug]) }}">
                                    ...
                                    <div class="card-body p-4"
                                        style="border-left: 4px solid #007bff; background: #fafbfc;">
                    ...
                    <!-- Read More Button -->
                    <div class="text-center">
                        <a href="{{ route('frontend.news.feed') }}" class="btn btn-primary btn-lg px-5 py-3">
                                            ...
                                            <div class="partner-logo-wrapper">
                                                @if ($partner->logo)
                                                    <img src="{{ asset('storage/' . $partner->logo) }}"
                                                        alt="{{ $partner->title }}" class="partner-logo">
                                                @else
