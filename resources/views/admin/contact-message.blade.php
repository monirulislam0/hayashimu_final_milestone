                            ...
                            <table class="table table-striped table-hover">
                                ...
                                @foreach($messages as $message)
                                    <tr>
                                        ...
                                        <td style="max-width: 120px; word-wrap: break-word;">{{ $message->created_at ? $message->created_at->format('d-m-Y') : '-' }}</td>
                                        <td style="max-width: 100px; word-wrap: break-word;">{{ $message->created_at ? $message->created_at->format('h:i A') : '-' }}</td>
