                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $page->title) }}" placeholder="Enter page title" required>
                                                @error('title')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $page->slug) }}" placeholder="Enter page slug" required>
                                                @error('slug')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="page_banner" name="page_banner" accept="image/*" onchange="previewBanner(event)">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status" name="status">
                                                    <option value="1" {{ old('status', $page->status) ? 'selected' : '' }}>Active</option>
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary mr-1 mb-1">Update Page</button>
                                            <a href="{{ route('admin.pages.index') }}" class="btn btn-light-secondary mr-1 mb-1">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
